                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="transaction[date_trans]" value="{{$date}}">
                        ...
                        <table class="table table-striped table-advance table-hover table-bordered" id="transactionDetails">
                            ...
                            <th class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="span1 form-control" style="text-align: right" id='grandTotal' name="transaction[total]" value="{{old('transaction.total')}}" readonly>
                                </div>
                            </th>
                            </tfoot>
                        </table>
